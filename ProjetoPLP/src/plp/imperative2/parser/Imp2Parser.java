...
public class Imp2Parser implements Imp2ParserConstants {
    ...
    public static void main(String args[]) {
            ...
            if(programa.checaTipo(new ContextoCompilacaoImperativa2(entrada))) {
...
/**TODO */
  static final public IdCanal PIdCanal() throws ParseException {
    trace_call("PIdCanal");
    try {
        Token token;
      token = jj_consume_token(IDENTIFIER);
                {if (true) return new IdCanal(token.toString());}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PIdCanal");
    }
  }

  static final public DeclaracaoCanal PDeclaracaoCanal() throws ParseException {
    trace_call("PDeclaracaoCanal");
    try {
        IdCanal id;
        Expressao exp;
    ...
    throw new Error("Missing return statement in function");
      ...
      trace_return("PDeclaracaoCanal");
    }
  }

  static final public CanalSwap PCanalSwap() throws ParseException {
    trace_call("PCanalSwap");
    try {
        IdCanal id;
        Expressao exp;
      ...
      id = PIdCanal();
      exp = PExpressao();
         {if (true) return new CanalSwap(id,exp);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PCanalSwap");
    }
  }

  static final public CanalSend PCanalSend() throws ParseException {
    trace_call("PCanalSend");
    try {
        IdCanal id;
        Expressao exp;
      ...
      id = PIdCanal();
      exp = PExpressao();
         {if (true) return new CanalSend(id,exp);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PCanalSend");
    }
  }

  static final public TryCanalSend PTryCanalSend() throws ParseException {
    trace_call("PTryCanalSend");
    try {
        IdCanal id;
        Expressao exp;
      ...
      id = PIdCanal();
      exp = PExpressao();
         {if (true) return new TryCanalSend(id,exp);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PTryCanalSend");
    }
  }

  static final public CanalPeek PCanalPeek() throws ParseException {
    trace_call("PCanalPeek");
    try {
        IdCanal id;
      jj_consume_token(PEEK);
      id = PIdCanal();
         {if (true) return new CanalPeek(id);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PCanalPeek");
    }
  }

  static final public CanalGet PCanalGet() throws ParseException {
    trace_call("PCanalGet");
    try {
        IdCanal id;
      jj_consume_token(GET);
      id = PIdCanal();
         {if (true) return new CanalGet(id);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PCanalGet");
    }
  }

  static final public TryCanalGet PTryCanalGet() throws ParseException {
    trace_call("PTryCanalGet");
    try {
        IdCanal id;
      jj_consume_token(TRY);
      jj_consume_token(GET);
      id = PIdCanal();
         {if (true) return new TryCanalGet(id);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PTryCanalGet");
    }
  }

  static final public Parallel PParallel() throws ParseException {
    trace_call("PParallel");
    try {
        Comando c1;
        Comando c2;
      c1 = PComandoSimples();
      ...
      c2 = PComando();
         {if (true) return new Parallel(c1, c2);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PParallel");
    }
  }
  ...
  static final public Expressao PExpressao() throws ParseException {
    ...
    try {
      ...
      if (jj_2_8(2)) {
        ...
        retorno = PTryCanalGet();
      } else if (jj_2_14(2147483647)) {
        retorno = PTryCanalSend();
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case TRUE:
        case FALSE:
...
/*  ADICIONADO OU MODIFICADO DA Imperativa1 PARA A Imperativa2  */
  ...
  static private boolean jj_3_11() {
    if (jj_scan_token(PEEK)) return true;
    if (jj_3R_6()) return true;
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x123b0000,0x180000,0x6000,0x6000,0x6000,0x1800,0x6000,0x6000,0x123b0000,0x5008000,0x1000000,0x0,0x0,0x0,0x0,0xe0007800,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x5200,0x0,0x0,0x110,0x1310,0x0,0x1310,0x1310,0x5200,0x1000,0x0,0x8600e,0xe,0xe,0x80000,0x1311,0x80000,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x20,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20,0x0,};
   }
